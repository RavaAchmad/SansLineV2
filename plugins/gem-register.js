...
const sections = [
    ...
    const listMessage = {
      text: daftar,
      footer: wm,
      mentions: await conn.parseMention(daftar),
      title: '',
      buttonText: "Klik Disini",
      sections
    }
    return conn.sendMessage(m.chat, listMessage, { quoted: m, mentions: await conn.parseMention(daftar), contextInfo: { forwardingScore: 99999, isForwarded: true }})
