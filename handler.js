...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.author = 'By 𝐒𝐀𝐍𝐒𝐋𝐈𝐍𝐄-𝐁𝐎𝐓'
        global.wm2 = global.data.namabot + ' ' + global.data.owner
        global.wm = namabot
        global.colong1 = 'Ciss '
        global.colong2 = 'By 𝐒𝐀𝐍𝐒𝐋𝐈𝐍𝐄-𝐁𝐎𝐓'
        global.kontak2 = [
        ['6281212035575', 'PilarBilek', 'Raja Satir Bilek', 'pilarbilek302@gmail.com', true],
        ['62812120355752', await this.getName('62812120355752@s.whatsapp.net'), 'Bilek', 'sa0066588@gmail.com', true],
        ['6281212035575', await this.getName('6281212035575@s.whatsapp.net'), 'Bilek', 'ravabbok@gmail.com', true],
        ['6281212035575', 'BOTKANJUD', 'Bot WhatsApp', 'Nothing!', true],
        ]
...
global.dfail = async (type, m, conn) => {
  ...
  contextInfo: { 
    ...
    mediaUrl: 'wa.me/6281212035575',
    mediaType: 2,
    description: 'github.com/RavaAchmad', 
    title: 'BY Rava',
    body: 'RavaAchmad.github.io',
    thumbnail: await(await fetch(img)).buffer(),
    sourceUrl: 'wa.me/6281212035575'
     }}
  })
}
